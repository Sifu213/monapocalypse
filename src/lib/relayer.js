// lib/relayer.js - Logique métier unifiée avec queue pour éviter les conflits
import { createWalletClient, getContract, http } from 'viem';
import { privateKeyToAccount } from 'viem/accounts';

// Adresses des contrats
const SIFU_CLICK_CONTRACT_ADDRESS = "0x86282eefde3e840fb660f04a4a5d4be85a4a8f79"; // ⚠️ Votre adresse déployée
const MONAD_CONTRACT_ADDRESS = "0xE1B25BEF05F647Fe93dE082769fc2e2E2A112a5b";

// ABI du contrat SifuClick (ultra simple)
...
// Factory function pour une utilisation simple
export async function handleRelayRequest(req, res) {
  try {
    ...
    console.error("❌ Erreur du relayer:", error);
    throw {
      status: error.message.includes("requis") || error.message.includes("invalide") ? 400 : 500,
